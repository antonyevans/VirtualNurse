...
public class BillingService extends Service implements ServiceConnection {
    ...
    public class RequestPurchase extends BillingRequest {
         ...
         *                purchase.
         * @param itemType  Either Constants.ITEM_TYPE_INAPP or Constants.ITEM_TYPE_SUBSCRIPTION,
        ...
        protected long run() throws RemoteException {
            ...
            if (mDeveloperPayload != null) {
                request.putString(Constants.BILLING_REQUEST_DEVELOPER_PAYLOAD, mDeveloperPayload);
            }
            Bundle response = mService.sendBillingRequest(request);
            PendingIntent pendingIntent
                    = response.getParcelable(Constants.BILLING_RESPONSE_PURCHASE_INTENT);
    ...
    private boolean bindToMarketBillingService() {
        try {
            ...
            boolean bindResult = bindService(
                    new Intent(Constants.MARKET_BILLING_SERVICE_ACTION),
     ...
     * @param itemType  Either Constants.ITEM_TYPE_INAPP or Constants.ITEM_TYPE_SUBSCRIPTION, indicating
     ...
     * in an intent with the action {@link Constants#ACTION_PURCHASE_STATE_CHANGED}.
